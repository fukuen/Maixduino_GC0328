#ifndef __MAIXDUINO_GC0328_H
#define __MAIXDUINO_GC0328_H
...
class Maixduino_GC0328 : public Camera{

public:
    Maixduino_GC0328(framesize_t frameSize = FRAMESIZE_QVGA, pixformat_t pixFormat = PIXFORMAT_RGB565);
    Maixduino_GC0328(uint16_t width, uint16_t height, pixformat_t pixFormat = PIXFORMAT_RGB565);
    ~Maixduino_GC0328();
